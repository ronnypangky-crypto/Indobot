...
TAKE_PROFIT  = float(os.environ.get("TAKE_PROFIT", "8000"))
TRAIL_PCT    = float(os.environ.get("TRAIL_PCT", "4.5"))
HARD_STOP    = float(os.environ.get("HARD_STOP", "3.2"))
...
MIN_SIGNALS  = int(os.environ.get("MIN_SIGNALS", "7"))
...
SCAN_INTERVAL = 30
PRICE_SPIKE_PCT = float(os.environ.get("PRICE_SPIKE_PCT", "2.0"))  # skip kalau naik > 3% dalam 5 menit
